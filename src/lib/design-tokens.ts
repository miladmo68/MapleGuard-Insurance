// Design System Tokens for MapleGuard Insurance
...
export const designTokens = {
  ...
  shadows: {
    ...
    focus: '0 0 0 3px rgba(31, 152, 255, 0.1)',
  ...
  container: {
    ...
    '2xl': '1408px',
    '3xl': '1536px',
    content: '70ch', // Max content width for readability
  },
} as const;

// Motion preferences helper
export const motionPreferences = {
  respectReducedMotion: (callback: () => void) => {
...
export const componentVariants = {
  ...
  card: {
    variant: {
      ...
      elevated: 'bg-white border border-neutral-200 shadow-soft-lg',
